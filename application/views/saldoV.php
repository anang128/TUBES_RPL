    ...
    <div class="content">
        <div class="panel panel-default">
            <div class="panel-heading">SALDO</div>
                ...
                <?php } ?>
                <form method="post" action="<?php echo base_url('index.php/saldoC/index'); ?>">
                    <div class="form-group">
                            <label for="formGroupExampleInput">Jumlah Saldo</label>
                            <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Rp. 10.000.000" name="tujuan" required >
                        </div>
                        <div class="form-group">
                            <label for="formGroupExampleInput">Isi Saldo</label>
                            <input type="number" class="form-control" id="formGroupExampleInput" placeholder="Isi Saldo" name="jumlah"required>
                        </div>      
                        <div class="form-group">
                            <input type="submit" class="btn btn-primary btn-right" value="Isi" placeholder="Simpan">
                        </div>
                    </div>
                </form>
            </div>
