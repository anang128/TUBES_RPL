...
<html lang="en">
  <head>
    ...
    <!-- My CSS -->
    <link rel="stylesheet" href="<?php echo base_url().'assets/css/dashboardV.css' ?>">
  ...
  <body>
    ...
    <div>
        ...
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                <div class="col">
                <img src="<?php echo base_url('assets/img/Thrift-shop-amico.svg') ?>" class="d-block" alt="..." height = 500px>
                </div>
                <h1 class="display-4">LeBaBe</h1>      
                <p class="lead">a web auction is useful for facilitating buyer and seller transactions.</p>
            </div>
        </div>
